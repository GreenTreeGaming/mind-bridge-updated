          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {supportFeatures.map((feature, index) => (
              <div
                ...
                className={`bg-card/50 backdrop-blur-md border border-primary/20 rounded-3xl shadow-xl p-8 transition-all duration-300 cursor-pointer ${hoveredFeature === index ? 'scale-105 shadow-2xl shadow-primary/20' : ''
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {mentalHealthResources.map((resource, index) => (
              <div
                key={index}
                className={`bg-card/50 backdrop-blur-md border border-primary/20 rounded-3xl shadow-xl p-8 group hover:-translate-y-2 transition-all cursor-pointer ${index === 0 ? 'md:col-span-2' : ''
                  }`}
              >
        ...
        <div className="flex gap-8 px-8 pb-8 overflow-x-auto scrollbar-hide">
          {recoveryStories.map((story, i) => (
            <div
              ...
              className={`bg-card/50 backdrop-blur-md border border-primary/20 rounded-3xl shadow-xl p-10 min-w-[400px] relative group transition-all duration-300 ${hoveredStory === i ? 'scale-105 shadow-2xl shadow-primary/20' : ''
                }`}
            >
